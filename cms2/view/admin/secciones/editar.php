<h3>
    ...
    <a href="<?php echo $_SESSION['home'] ?>admin/secciones" title="Secciones">Secciones</a> <span>| </span>
    <?php if ($datos->id){ ?>
...
<div class="row">
    ...
    <form class="col s12" method="POST" enctype="multipart/form-data" action="<?php echo $_SESSION['home'] ?>admin/secciones/editar/<?php echo $id ?>">
        <div class="col m12 l6">
            <div class="row">
                ...
                <div class="input-field col s12">
                    <input id="presidente" type="text" name="presidente" value="<?php echo $datos->presidente ?>">
        ...
        <div class="row">
            <div class="input-field col s12">
                <a href="<?php echo $_SESSION['home'] ?>admin/secciones" title="Volver">
